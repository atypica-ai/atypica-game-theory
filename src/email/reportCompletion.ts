...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>您好，</p>
  <p>您关于"${title}"的研究报告已成功生成，现在可以查看了。</p>
...
`,
      ...
      : {
          ...
          text: `
Hello,
Your study report for "${title}" has been successfully generated and is now available for viewing.
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Hello,</p>
  <p>Your study report for "${title}" has been successfully generated and is now available for viewing.</p>
  <div style="margin: 20px 0;">
