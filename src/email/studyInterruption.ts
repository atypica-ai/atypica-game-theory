  ...
  const emailOptions: EmailOptions =
    locale === "zh-CN"
      ? {
          ...
          text: `
您好，
您关于"${title}"的研究意外中断。请勿担心，您的进度已被保存。
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>您好，</p>
  <p>您关于"${title}"的研究意外中断。请勿担心，您的进度已被保存。</p>
...
`,
      ...
      : {
          ...
          text: `
Hello,
Your study on "${title}" was unexpectedly interrupted. Don't worry, your progress has been saved.
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Hello,</p>
  <p>Your study on "${title}" was unexpectedly interrupted. Don't worry, your progress has been saved.</p>
