...
export default function InfluencersPage() {
  ...
  const t = useTranslations("Solutions.InfluencersPage");
          ...
          >
            ...
            <HeroTitle>
              <span className="font-EuclidCircularA font-normal text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-[1.3]">
                {isZh ? (
                  <>
                    将<span className="font-bold">信任变现</span>
                  </>
                ) : (
                  <>
                    <span className="font-bold">Monetize</span> Trust
                  </>
                )}
              </span>
            </HeroTitle>
