...
export default function InfluencersPage() {
  ...
  const t = useTranslations("Solutions.InfluencersPage.UseCasesSection");
  ...
  return (
    <div className="relative">
        ...
        <div className="container mx-auto relative h-full">
          ...
          >
            <p className="text-base md:text-lg lg:text-xl font-medium tracking-[0.22em] uppercase text-muted-foreground mb-6">
              {isZh ? "Atypica For Influencers" : "ATYPICA For Influencers"}
            </p>
      ...
      <CaseStudiesSection tag="influencers" />
