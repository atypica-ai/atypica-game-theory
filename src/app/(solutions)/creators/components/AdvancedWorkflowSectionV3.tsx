  ...
  return (
    <section className="py-32 md:py-40 bg-white dark:bg-zinc-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        {/* Title */}
        <h2 className="font-EuclidCircularA font-bold text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-tight mb-6 text-zinc-900 dark:text-white">
          {t("title")}
        </h2>
        ...
        <div className="space-y-32">
          ...
          {/* Workflow 2 */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center border-t border-zinc-200 dark:border-zinc-800 pt-32">
            <div className="lg:col-span-2">
