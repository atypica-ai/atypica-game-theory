          ...
          {useCases.map((useCase, index) => (
            <div
              ...
              style={{
                ...
                // ringColor: hoveredCard === useCase.id ? useCase.color : "transparent", // Not a valid CSS property
              }}
            ...
            >
              ...
              {index === 0 || index === 2 ? (
                <div className="space-y-2 mb-4 text-xs text-zinc-600 dark:text-zinc-400 italic">
                  {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                  <p>&ldquo;{t(`useCase${index + 1}.example1` as any)}&rdquo;</p>
                  {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                  <p>&ldquo;{t(`useCase${index + 1}.example2` as any)}&rdquo;</p>
                </div>
              ) : (
                <ul className="space-y-2 text-xs text-zinc-700 dark:text-zinc-300 mb-4">
                  {[1, 2, 3, 4].map((pointNum) => (
                    <li key={pointNum} className="flex items-start gap-2">
                      ...
                      />
                      {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                      <span>{t(`useCase${index + 1}.point${pointNum}` as any)}</span>
                    </li>
                  ))}
                </ul>
              )}
              ...
              {(index === 0 || index === 2) && (
                <div className={`pt-4 border-t border-${useCase.borderColor}`}>
                  ...
                  <p className="text-xs text-zinc-700 dark:text-zinc-300">
                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                    {(t as any)(`useCase${index + 1}.output`)}
                  </p>
                </div>
              )}
