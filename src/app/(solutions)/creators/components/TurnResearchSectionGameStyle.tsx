...
export function TurnResearchSectionGameStyle() {
  ...
  const t = useTranslations("CreatorPage.TurnResearchSection") as any;
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed">
                      {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                      {(t as any)(`outputs.output${index + 1}`)}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                ...
                />
                {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                <span className="text-sm text-zinc-700 dark:text-zinc-300">{(t as any)(`idealFor.type${i}`)}</span>
              </div>
            ))}
          </div>
        </div>
              ...
              {[1, 2, 3].map((i) => (
                <li key={i} className="flex items-start gap-3 group">
                  ...
                  <span className="text-base text-zinc-700 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-white transition-colors">
                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                    {(t as any)(`reuseOptions.option${i}`)}
                  </span>
                </li>
              ))}
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              ...
              >
                <p className="text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed">
                  {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                  {(t as any)(`realExamples.example${i}`)}
                </p>
              </div>
            ))}
          </div>
