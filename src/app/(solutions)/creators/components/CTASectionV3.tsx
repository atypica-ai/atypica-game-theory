...
export function CTASectionV3() {
  ...
  return (
    <section className="py-32 md:py-40 bg-white dark:bg-zinc-950 text-center">
      <div className="container mx-auto px-4 max-w-screen-2xl">
        {/* Headlines - Bold Statement (but within global max size) */}
        <div className="mb-16 max-w-6xl mx-auto">
          <h2 className="font-EuclidCircularA font-bold text-3xl md:text-4xl lg:text-5xl xl:text-7xl tracking-tight leading-[0.95] mb-6 text-zinc-900 dark:text-white">
            {t("headline")}
          </h2>
          <p className="text-2xl md:text-3xl lg:text-5xl font-bold text-brand-green mb-6 leading-tight">
            {t("subheadline")}
          </p>
