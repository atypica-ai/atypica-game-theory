  ...
  return (
    <section className="bg-zinc-100 dark:bg-zinc-800 py-20 md:py-28">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div
          className={cn("mt-10 border-t border-border pt-8", "flex flex-col items-center gap-4")}
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 245 240" xmlns="http://www.w3.org/2000/svg">
                <path
