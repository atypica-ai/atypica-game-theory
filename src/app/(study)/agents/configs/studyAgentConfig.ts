...
function buildStudyTools({
  ...
  return {
    ...
    [StudyToolName.searchPersonas]: searchPersonasTool({ ...contextfulAgentToolArgs, autoCreatePanel: true }),
    [StudyToolName.scoutTaskChat]: scoutTaskChatTool({ ...contextfulAgentToolArgs }),
    [StudyToolName.buildPersona]: buildPersonaTool({ ...contextfulAgentToolArgs, autoCreatePanel: true }),
    ...
    [StudyToolName.playGame]: playGameTool({ ...agentToolArgs }),
