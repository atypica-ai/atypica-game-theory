...
【洞察报告专属设计要求】
**视觉定位**：McKinsey 的严谨 + 人类学的人文 + 编辑设计的精致

这是严谨的商业分析，但关于真实的人。视觉语言要平衡权威感与人文温度。

**设计手法**：
- **编辑设计的严谨性** - 成熟的排版、清晰的结构、精确的层级
- **抽象化的人文感** - 用插画和抽象图形传达人文关怀，而非写实照片
- **几何与秩序美学** - 用几何构图、平衡布局体现系统性思考

**执行方式**：
- 遵循 shared 中的统一设计规范（单色文字、品牌色点缀、抽象插画）
- 通过排版细节和视觉节奏传达人文温度
- 用抽象图形背景营造氛围，不用写实照片
