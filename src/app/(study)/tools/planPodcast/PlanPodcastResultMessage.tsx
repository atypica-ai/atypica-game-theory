...
export const PlanPodcastResultMessage = ({
  toolInvocation,
}: {
  toolInvocation: Extract<
    ToolUIPart<Pick<StudyUITools, StudyToolName.planPodcast>>,
    { state: "output-available" }
  >;
}) => {
  const t = useTranslations("Components.PlanPodcastResultMessage");
  ...
  return (
    <div className="p-3 text-foreground bg-zinc-50 dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 rounded-lg text-xs">
      ...
      <div className="text-xs">
        ...
        {formattedHtml ? (
          <div
            className="formatted-podcast-plan prose prose-sm max-w-none dark:prose-invert"
