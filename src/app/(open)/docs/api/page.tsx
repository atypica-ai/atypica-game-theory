    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="mb-8 md:hidden">
          <h1 className="text-2xl font-bold mb-1">atypica.AI API</h1>
          <p className="text-sm text-muted-foreground">v1.0.0 • REST API</p>
        </div>

        {/* Mobile Navigation */}
        <nav className="mb-8 pb-6 border-b border-border md:hidden">
          ...
          <ul className="grid grid-cols-2 gap-2 text-sm">
            ...
            <li>
              <a href="#base-url" className="text-primary hover:underline block py-1">
                Base URL
              </a>
            </li>
            <li>
              <a href="#list-members" className="text-primary hover:underline block py-1">
                List Members
              </a>
            </li>
            <li>
              <a href="#create-user" className="text-primary hover:underline block py-1">
                Create User
              </a>
            </li>
            <li>
              <a href="#invite-user" className="text-primary hover:underline block py-1">
                Invite User
              </a>
            </li>
            <li>
              <a href="#impersonation" className="text-primary hover:underline block py-1">
                Impersonation
              </a>
            </li>
            <li>
          ...
          <div className="space-y-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-md p-4">
              <p className="text-sm text-foreground">
                <strong>Note:</strong> API access requires a team account. Personal accounts do not
                support API access.
              </p>
            </div>
      ...
      "personalUserId": 123
        ...
        <section id="create-user" className="mb-16 scroll-mt-8">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Create a new user and add them to the team. The email domain must be verified in your
            team&apos;s domain whitelist.
          </p>
    ...
    "createdAt": "2024-01-01T00:00:00.000Z"
        ...
        <section id="invite-user" className="mb-16 scroll-mt-8">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            ...
            account, and their email domain must be verified in your team&apos;s domain whitelist.
          </p>
  ...
  "data": {
    ...
    "expiresAt": "2024-01-02T00:00:00.000Z"
        ...
        <section id="errors" className="mb-16 scroll-mt-8">
          <h2 className="text-lg font-bold mb-6 border-b border-border pb-2">Error Responses</h2>
