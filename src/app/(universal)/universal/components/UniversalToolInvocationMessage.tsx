...
/**
 * Compact tool invocation display for Universal Agent.
 * Shows a single-line summary with expand-to-reveal args/result.
 */
export const UniversalToolInvocationMessage = ({
  toolInvocation,
}: {
  toolInvocation: DynamicToolUIPart | ToolUIPart<PlainTextUITools>;
}) => {
