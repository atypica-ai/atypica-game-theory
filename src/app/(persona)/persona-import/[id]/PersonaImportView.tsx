...
interface PersonaImportViewProps {
...
export function PersonaImportView({
  ...
  const hasError = Boolean((personaImport.extra as any)?.error);

  // Check individual completion status
  const summaryCompleted = Boolean(personaImport.summary);
  ...
  // Show error state
  if (hasError) {
    const errorMessage = (personaImport.extra as any)?.error;
    return (
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-white/40 shadow-xl p-8">
              <ProcessingStatus
                isProcessing={!summaryCompleted}
                isAnalyzing={!analysisCompleted}
                personaSummary={personaImport.summary || ""}
                analysis={analysis}
            ...
            {/* Generated Personas - only show if personas exist */}
            {personas.length > 0 && (
              <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-white/40 shadow-xl p-8">
                <div className="space-y-6">
                  <div className="space-y-2">
