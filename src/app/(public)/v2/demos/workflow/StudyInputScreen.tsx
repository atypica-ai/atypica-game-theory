...
export default function StudyInputScreen({
  ...
  return (
    ...
    >
      ...
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={L.text} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        {refStudy && (
          <div className="flex items-center gap-1.5 mb-2">
            <span className="text-xs" style={{ color: L.textFaint }}>{t("workflow.demos.ui.refLabel")}</span>
        ...
        <div className="rounded-lg overflow-hidden shadow-sm" style={{ background: "white", border: `1px solid ${L.border}` }}>
          {/* Clarify link */}
          <div className="flex items-center gap-1.5 px-3 pt-2.5">
            ...
            <span style={{ color: accent, fontSize: "10px" }}>{t("workflow.demos.ui.clarifyLink")}</span>
          </div>
          ...
          {/* Bottom toolbar */}
          <div className="flex items-center gap-1.5 px-3 py-2" style={{ borderTop: `1px solid ${L.borderLight}` }}>
            <button type="button" className="flex items-center justify-center w-7 h-7 rounded-lg" style={{ background: L.bgSub }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke={L.textMuted} strokeWidth="1.5" strokeLinecap="round">
