...
export const SOLUTION_STORY_IMAGE_PROMPTS = {
  food: "Editorial still life on warm off-white tabletop: three premium Lunar New Year chocolate packaging concepts arranged neatly like a brand review board, tactile paper boxes with subtle red and gold details, small color swatches and selection markers, soft daylight, realistic but slightly stylized, elegant composition, no people, no text, no futuristic AI motifs.",
  tools:
    "Industrial design review table on a clean studio surface: cordless power tool prototype in soft grey and blue, foam mockup details, material chips, ergonomic markers and workshop objects arranged with care, soft daylight, realistic but tasteful editorial product photography, no people, no text, no lettering, no labels, no sci-fi elements.",
} as const;
