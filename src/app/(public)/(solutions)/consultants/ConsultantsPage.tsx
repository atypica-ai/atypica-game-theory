...
export default function ConsultantsPage() {
  ...
  const t = useTranslations("Solutions.ConsultantsPage");
  ...
  return (
    <div className="relative">
          ...
          >
            ...
            <HeroTitle>
              <span className="font-EuclidCircularA font-normal text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-[1.3]">
                {isZh ? (
                  <>
                    展示<span className="font-bold">消费者证据</span>，而非幻灯片
                  </>
                ) : (
                  <>
                    Show <span className="font-bold">consumer proof</span>, more than slides
                  </>
                )}
              </span>
            </HeroTitle>
      ...
      <CaseStudiesSection tag="consultants" title={t("CaseStudiesSection.title")} />
