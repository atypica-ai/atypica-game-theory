...
const INTERACTION_HERO_PROMPT =
  "A wide panoramic scene of multiple clusters of pixel-art figures on floating geometric platforms. Left cluster: two figures in close one-on-one conversation with speech particles between them. Center: one figure addressing a semicircle of 8-10 smaller figures. Right: 5-6 figures in a circular group discussion with a shared particle cloud above. Background cluster: a figure observing others from distance. Each cluster has distinct color temperature — warm amber for intimate talk, sage green for group sessions, cool blue for observation. Faint luminous bridges connect platforms. Abstract particle streams flow between clusters. Background: clean gradient from warm cream to soft gray. Style: detailed pixel art with atmospheric depth. Wide aspect ratio, spacious. No text.";
