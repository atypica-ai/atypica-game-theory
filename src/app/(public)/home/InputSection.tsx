...
import { ArrowRightIcon, CommandIcon, RotateCwIcon } from "lucide-react";
  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit} className="relative group">
        {/* Command-style input header */}
        <div className="flex items-center gap-2 mb-2 text-xs text-muted-foreground">
          <CommandIcon className="h-4 w-4" />
          <span className="font-mono">{t("label")}</span>
        </div>

        <div className="relative border border-border bg-background transition-colors hover:border-primary focus-within:border-primary">
          <Textarea
            value={input}
            onChange={(e) => {
