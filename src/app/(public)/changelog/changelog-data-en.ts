...
export const changelogDataEN: ChangelogSection[] = [
        ...
        items: [
          {
            icon: "star",
            title:
              'Major Feature: <a href="https://atypica.ai/panels" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">AI Panel (Research Panels)</a>',
            description:
              "Group multiple AI Personas into reusable research panels. Launch group discussions, one-on-one interviews, and other research types directly from a panel. All outputs (reports, podcasts, etc.) are organized in one place. Reuse the same panel across projects for more efficient and consistent research.",
          },
          {
            icon: "search",
            title: "Platform-Wide Search",
            description:
              "Studies, AI Personas, interview projects, panels, reports, and podcasts are all searchable now. Finding past research and content is much faster.",
          },
          {
            icon: "paperclip",
            title: "File Uploads in Research",
            description:
              "Upload PDFs, images, and other reference materials during research and interviews. The AI actively reads and references these files throughout the analysis, grounding research in your existing materials.",
          },
          {
            icon: "brain",
            title:
              'Personal Memory: <a href="https://atypica.ai/user/memory-builder" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Build Your Personal Profile</a>',
            description:
              "Introducing user-level personal memory (previously only available for teams). Through a short conversation, the AI learns your background, role, and interests, then automatically applies this context to all future research. The more you use it, the better it understands you — no need to repeat yourself.",
          },
          {
            icon: "brain",
            title: "Team Memory Experience Upgrade",
            description:
              "Redesigned team memory builder with a smoother interview flow. After completing the interview, the AI automatically suggests research topics tailored to your team to help you start your next study right away.",
          },
          {
            icon: "users",
            title: "Richer Persona Profiles",
            description:
              "Each Persona now comes with auto-generated role tags and demographic attributes, plus a self-introduction. Easier to understand who each Persona represents at a glance.",
          },
          {
            icon: "bar-chart-3",
            title: "Report Visual Upgrade",
            description:
              "Research reports have been redesigned with a typography-first approach, emphasizing readability and visual hierarchy. Reports are now cleaner and more professional.",
          },
          {
            icon: "palette",
            title: "Unified List Page Design",
            description:
              "All list pages (studies, personas, interviews, panels) now share a consistent card-style layout with pagination for a smoother browsing experience.",
          },
        ],
      },
    ],
  ...
  {
    title: "v1.4.x: Open Platform & Agent Ecosystem",
    versions: [
      {
        version: "v1.4.0",
        date: "2026-01-31",
  ...
  {
    title: "v1.3.x: Intelligent Memory & Intent Understanding",
    versions: [
      {
        version: "v1.3.0",
        date: "2026-01-08",
  ...
  {
    title: "v1.2.x: Group Research & Discussion Mode",
    versions: [
      {
        version: "v1.2.0",
        date: "2025-12-27",
  ...
  {
    title: "v1.1.x: AI Research Platform & Developer Tools",
    versions: [
      {
        version: "v1.1.3",
        date: "2025-12-11",
        items: [
          ...
          {
            icon: "play",
            title: "UX Improvements: Enhanced Replay Feature",
            description:
  ...
  {
    title: "v1.0.x: Multimodal Research & Content Generation",
    versions: [
      {
        version: "v1.0.2",
        date: "2025-11-01",
  ...
  {
    title: "v0.9.x: Guided Research Strategy & Transparency",
    versions: [
      {
        version: "v0.9.0",
        date: "2025-09-15",
        items: [
          {
            icon: "map",
            title: "Guided Planning Before AI Research Starts",
            description:
  ...
  {
    title: "v0.8.x: AI Interview & AI Persona Full Launch",
    versions: [
      {
        version: "v0.8.0",
        date: "2025-09-04",
  ...
  {
    title: "v0.7.x: Enterprise Collaboration & Data Insights",
    versions: [
      {
        version: "v0.7.1",
        date: "2025-08-08",
  ...
  {
    title: "v0.6.x: Globalization & Intelligent Enhancement",
    versions: [
      {
        version: "v0.6.2",
        date: "2025-07-28",
  ...
  {
    title: "v0.5.x: Intelligent Reports & UX Leap",
    versions: [
      {
        version: "v0.5.1",
        date: "2025-05-31",
  ...
  {
    title: "v0.4.x: Platform Architecture Upgrade",
    versions: [
      {
        version: "v0.4.1",
        date: "2025-04-30",
  ...
  {
    title: "v0.3.x: Conversational Research Assistant",
    versions: [
      {
        version: "v0.3.1",
        date: "2025-04-03",
  ...
  {
    title: "v0.2.x: Step-by-Step Research Process",
    versions: [
      {
        version: "v0.2.0",
        date: "2025-03-15",
  ...
  {
    title: "v0.1.x: User Discovery Tool",
    versions: [
      {
        version: "v0.1.0",
        date: "2025-03-12",
