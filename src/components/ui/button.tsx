...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default: cn("bg-primary text-primary-foreground shadow-xs hover:bg-primary/90"),
        destructive: cn(
        ...
        secondary: cn("bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80"),
