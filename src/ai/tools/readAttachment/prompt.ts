...
【读取方式】使用 readAttachment 工具按需读取附件内容：首次遇到建议用 head_tail 模式快速预览，如需完整内容再用 full 模式读取。
...
【Read】Use the readAttachment tool to read content on demand: use head_tail mode to preview first, then full mode for complete content.
