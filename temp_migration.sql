...
-- CreateEnum
CREATE TYPE "UserTokensLogResourceType" AS ENUM ('StudyUserChat', 'ScoutUserChat', 'GenericUserChat', 'InterviewProject', 'PaymentRecord', 'UserSubscription', 'PersonaImport');

-- CreateEnum
CREATE TYPE "UserTokensLogVerb" AS ENUM ('recharge', 'consume', 'subscription', 'gift', 'signup', 'subscriptionReset');
