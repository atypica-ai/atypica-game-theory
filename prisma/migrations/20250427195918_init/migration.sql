...
-- CreateEnum
CREATE TYPE "UserChatKind" AS ENUM ('scout', 'study', 'interview', 'misc');
...
-- CreateEnum
CREATE TYPE "UserTokensLogResourceType" AS ENUM ('StudyUserChat', 'ScoutUserChat', 'PaymentRecord');
...
CREATE TABLE "UserAnalyst" (
    ...
    CONSTRAINT "UserAnalyst_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "UserAnalyst_userId_idx" ON "UserAnalyst"("userId");

-- CreateIndex
CREATE INDEX "UserAnalyst_analystId_idx" ON "UserAnalyst"("analystId");

-- CreateIndex
CREATE UNIQUE INDEX "UserAnalyst_userId_analystId_key" ON "UserAnalyst"("userId", "analystId");
